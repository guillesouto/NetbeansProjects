 ...
 * @author roger
 */
public class EjemploPiramideCubo implements GLEventListener {
    ...
    public static void main(String[] args) {
      ...
      EjemploPiramideCubo l= new EjemploPiramideCubo();
 ...
 //       gl.glTranslatef(0.0f, 0.0f, -6.0f);   
        ...
        gl.glTranslatef(1.5f, -1.0f, -8.0f);  // Move right and into the screen
        ...
        // Bottom face (y = -1.0f)
        gl.glColor3f(0.0f, 0.5f, 0.5f);     // Orange
        gl.glVertex3f(1.0f, -1.0f, 1.0f);
        gl.glVertex3f(-1.0f, -1.0f, 1.0f);
        gl.glVertex3f(-1.0f, -1.0f, -1.0f);
        gl.glVertex3f(1.0f, -1.0f, -1.0f);
        ...
        gl.glLoadIdentity();                  // Reset the model-view matrix
        gl.glTranslatef(-0.1f, 0.0f, -6.0f);  // Move left and into the screen
        ...
        //glut.glutSwapBuffers();  // Swap the front and back frame buffers (double buffering)        
    ...
    public void reshape(GLAutoDrawable glad, int i, int i1, int width, int height) {
        ...
        //AL APLICAR BORRAR LA LINEA DE ABAJO 
        //*----------CORTAR ACA------------------*//*
        ...
        glu.gluPerspective(60.0f, h, 0.1f, 100.0f);
    }
    */
    @Override
    public void reshape(GLAutoDrawable glad, int i, int i1, int width, int height) {
