...
// Nombres de archivos de informes
      String[] reports = {"ENT_FAC_001.txt", "SAL_COM_001.txt", "ENT_COM_002.txt", "SAL_FAC_002.txt", "MIX_FAC_001.txt", "MIX_COM_001.txt", "ENT_PED_001.txt", "MIX_PED_001.txt",};
...
// Simulación del procesado de informes
        for (String report : reports) {
            ...
            } else if (report.contains("PED")) {
                System.out.println("Procesando informe de PEDIDO de tipo "
                        + getType(report));
